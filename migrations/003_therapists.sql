...
CREATE INDEX idx_therapists_organization_id     ON therapists (organization_id);
CREATE INDEX idx_therapists_user_id             ON therapists (user_id);
CREATE INDEX idx_therapists_public_slug         ON therapists (public_slug);
CREATE INDEX idx_therapists_verification_status ON therapists (verification_status);
CREATE INDEX idx_therapists_marketplace_enabled ON therapists (id) WHERE marketplace_enabled = TRUE;
CREATE INDEX idx_therapists_radar_availability  ON therapists (availability_status, radar_active);
CREATE INDEX idx_therapists_languages_gin       ON therapists USING GIN (languages);
CREATE INDEX idx_therapists_specializations_gin ON therapists USING GIN (specializations);
CREATE INDEX idx_therapists_not_deleted         ON therapists (id) WHERE deleted_at IS NULL;
...
CREATE INDEX idx_therapist_credentials_therapist_id ON therapist_credentials (therapist_id);
...
CREATE INDEX idx_therapist_availability_day_active   ON therapist_availability (day_of_week, is_active);
...
CREATE INDEX idx_therapist_avail_exceptions_therapist_date
...
CREATE INDEX idx_therapist_specializations_therapist_id ON therapist_specializations (therapist_id);
