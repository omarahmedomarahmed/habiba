...
import {
  ...
  ChevronRight, BarChart2, Zap, Users, Settings, ExternalLink
} from 'lucide-react';
...
// NOTE: PLAN_PRICING has been REMOVED.
// Plans are now managed via /admin/pricing — the Pricing Management page.
// All pricing data comes from the backend /billing/admin/plans API.
// DO NOT add hardcoded pricing here.
