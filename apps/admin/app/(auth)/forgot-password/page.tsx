...
export default function AdminForgotPasswordPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Still show success for security (don't reveal existence of email)
      setSent(true);
    } finally {
      setLoading(false);
    }
        ...
        <div className="w-full max-w-sm">
          <div className="bg-slate-900 border border-slate-700 rounded-2xl p-8 text-center">
            ...
            <p className="text-slate-400 text-sm mb-6">
              If <span className="text-white font-medium">{email}</span> is registered as an admin,
              you&apos;ll receive a password reset link within 2 minutes.
            </p>
            <p className="text-xs text-slate-500 mb-6">
              Check your spam folder if you don&apos;t see it. For security, the link expires in 1 hour.
            </p>
            <Link
              href="/login"
        ...
        <div className="bg-slate-900 border border-slate-700 rounded-2xl p-8">
          <div className="mb-6">
            ...
            <p className="text-slate-400 text-sm">
              Enter your admin email address. We&apos;ll send a secure reset link.
            </p>
          </div>
