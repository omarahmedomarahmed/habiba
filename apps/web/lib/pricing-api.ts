...
const FALLBACK_PLANS: SubscriptionPlan[] = [
  {
    ...
    description: "10 AI-scripted sessions per month, no credit card needed",
    price_monthly_usd: 0,
    price_annual_usd: 0,
    max_therapists: 1,
    max_patients: 10,
  ...
  },
  {
    ...
    plan_key: "starter",
    name: "Starter",
    tagline: "Essential AI for growing solo practices",
    description: "Perfect for therapists seeing 1–20 patients",
    price_monthly_usd: 49,
    price_annual_usd: 490,
    max_therapists: 1,
    max_patients: 20,
    max_sessions_month: null,
    ai_notes_included: 50,
    features: {
      radar: false,
      api_access: false,
      white_label: false,
  ...
  },
  {
    ...
    name: "Professional",
    tagline: "Unlimited AI for serious solo practitioners",
  ...
  },
  {
    ...
    plan_key: "practice",
    name: "Practice",
    tagline: "Multi-therapist team with shared intelligence",
