...
import {
  ArrowLeft, Video, Copy, Check, Mail, X, Send,
  Calendar, Clock, Link2, Loader2
} from "lucide-react";
    ...
    <div className="p-6 max-w-xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Create a session and share the join link</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        {/* Invite emails (optional, pre-create) */}
        <div className="bg-white rounded-2xl border border-slate-200 shadow-card p-5">
