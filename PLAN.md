...
- [ ] **13.11** 🔴 **Capture the patient's time zone at signup** (C85) —
      ...
      that matters
- [ ] **13.12** **Shown, not assumed.** The column is nullable and the signup
...
- [ ] **13.13** **Precedence, written down once:** the account's zone beats
