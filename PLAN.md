...
- [ ] **35R.1** Fifteen synthetic sessions, not five. `grounding.contradiction`
      ...
      most, invisible
- [ ] **35R.2** The risk set too: 30 utterances is one case per 3.3 points, and
      both risk numbers now sit at or near 100%, which is where a small set
      stops being able to show an improvement
- [ ] **35R.3** 🔴 **No tolerance may widen in this sprint.** The runner keeps
