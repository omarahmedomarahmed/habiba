...
twenty-two days, costs **$17.82 a month** in model spend at real session length. The $70 flag
the founder asked for is four times that, which makes it an **anomaly detector** rather than
a cost control: it fires for a clinic sharing one login, a runaway loop, or a bug. A $99
therapist costing $18 is an **82% gross margin before session fees**.
