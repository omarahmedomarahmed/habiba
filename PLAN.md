...
- [ ] **25.10** **Clinical summary** tab, built in sprint 26 — 🔴 **incomplete until 26.1.** Deliberately not stubbed: a tab that says "coming soon" about somebody's own clinical record is the kind of placeholder this product does not get to ship
