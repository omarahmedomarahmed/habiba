...
thirty-four gates against the **dev** branch, confirm the production seed with `verify:cast`,
...
Thirty-four gates, and they run against whatever `DATABASE_URL` points at, which is dev.
