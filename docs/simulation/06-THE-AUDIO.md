...
|---|---|---|---|
| Online (`TH8`, `TH9`) | `<name>-t.wav` | `<name>-p.wav` | The room records two tracks: the therapist's microphone as "You" and the patient's video track as "Them" (`TH8.4`). One side each is what a real call sounds like, and it tests the speaker labels |
