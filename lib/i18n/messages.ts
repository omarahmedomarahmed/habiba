...
export const en = {
  ...
  */
  ...
  "sint.step2Body": "Your system sends us a staff number. We answer whether we fund that person.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "sint.step2Body": "يرسل نظامك إلينا رقمًا وظيفيًا. فنجيب هل نموّل هذا الشخص.",
