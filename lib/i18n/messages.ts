...
export const en = {
  ...
  */
  ...
  "sint.body": "One question, answered from your own system: does this person work here. Nothing else crosses, in either direction.",
  "sint.enableTitle": "Employment verification",
  "sint.neverTitle": "What this does not do",
  "sint.neverBody": "We never read your directory, never sync it, and never store a staff list. There is no roster of your people here and no table one could go in.",
  "sint.onlyBody": "What happens instead: somebody enrolling types their own staff number. We ask your system about that one identifier, the question is only valid for a short window after they typed it, and we get back yes or no. We never ask about anybody who has not asked us to.",
  "sint.pickSystem": "Which HR system",
  "sint.turnOn": "Turn it on",
  "sint.turnOff": "Turn it off",
  "sint.offRevokes": "Turning it off revokes every key on this account, so calls using them stop at once. Turning it back on means generating a new one.",
  ...
  "sint.neverAnswered": "No question has been answered yet. This turns green when a real call succeeds, not when a setting is saved.",
  ...
  "sint.step2Body": "We send an identifier somebody typed into their own enrolment. Your system replies with whether that person works there, and nothing else.",
  "sint.step3": "Generate your key",
  "sint.step3Body": "It belongs to this account and can ask about nobody else's staff. It is shown once, here, and stored nowhere we can read it back.",
  "sint.step4": "Watch the first call arrive",
  "sint.step4Body": "The indicator above turns green when your system answers one. Every call is in the log below, with what your side returned.",
  ...
  "sint.revoke": "Revoke",
  "sint.revokedMeans": "A revoked key stops working immediately, and every call made with it afterwards appears in the log below as refused. That is how you tell a revoked key from a broken endpoint.",
  "sint.attemptsTitle": "Enrolments that did not match, last seven days",
  "sint.attemptsBody": "Somebody typed a staff number your system did not recognise. A few is normal. A lot usually means your joining code has reached people it was not meant for, which is a thing only you can check.",
  "sint.logTitle": "What we sent you",
  "sint.logBody": "Every call, what your side returned, and the error when there was one. You can debug your own end without asking us what happened.",
  "sint.logEmpty": "Nothing yet.",
  "sint.logWhen": "When",
  "sint.logEvent": "Event",
  "sint.logStatus": "Status",
  "sint.logError": "Error",
  "sint.logNoNames": "No name, no staff number and no identifier appears in this log, ever. A connection log that recorded who each call was about would rebuild the staff list we do not keep, one row at a time.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "sint.body": "سؤال واحد، يُجاب من نظامكم أنتم: هل يعمل هذا الشخص هنا. ولا شيء غير ذلك يعبر، في أي اتجاه.",
  "sint.enableTitle": "التحقق من التوظيف",
  "sint.neverTitle": "ما لا يفعله هذا",
  "sint.neverBody": "لا نقرأ دليلكم أبدًا، ولا نزامنه، ولا نخزّن قائمة موظفين. لا توجد قائمة بموظفيكم هنا ولا جدول يمكن أن توضع فيه.",
  "sint.onlyBody": "ما يحدث بدلًا من ذلك: من ينضم يكتب رقمه الوظيفي بنفسه. ثم نسأل نظامكم عن ذلك المعرّف وحده، ولا يصلح السؤال إلا لنافذة قصيرة بعد كتابته، فتصلنا نعم أو لا. ولا نسأل أبدًا عن أحد لم يطلب منا ذلك.",
  "sint.pickSystem": "أي نظام موارد بشرية",
  "sint.turnOn": "شغّله",
  "sint.turnOff": "أوقفه",
  "sint.offRevokes": "إيقافه يلغي كل مفتاح على هذا الحساب، فتتوقف المكالمات التي تستخدمه فورًا. وتشغيله ثانية يعني توليد مفتاح جديد.",
  "sint.connected": "متصل",
  "sint.notConnected": "غير متصل بعد",
  "sint.lastAnswered": "آخر مرة أجاب فيها نظامكم سؤالًا: {when}.",
  "sint.neverAnswered": "لم يُجَب أي سؤال بعد. يتحول هذا إلى الأخضر حين تنجح مكالمة حقيقية، لا حين يُحفظ إعداد.",
  ...
  "sint.step2Body": "نرسل معرّفًا كتبه شخص في تسجيله الخاص. ويردّ نظامكم بما إذا كان يعمل لديكم، ولا شيء غير ذلك.",
  "sint.step3": "ولّد مفتاحك",
  "sint.step3Body": "هو ملك هذا الحساب ولا يستطيع السؤال عن موظفي أحد آخر. يُعرض مرة واحدة، هنا، ولا يُخزَّن في مكان نستطيع قراءته منه.",
  "sint.step4": "راقب وصول أول مكالمة",
  "sint.step4Body": "يتحول المؤشر أعلاه إلى الأخضر حين يجيب نظامكم عن واحدة. وكل مكالمة موجودة في السجل أدناه بما ردّه طرفكم.",
  ...
  "sint.revoke": "إلغاء",
  "sint.revokedMeans": "المفتاح الملغى يتوقف فورًا، وكل مكالمة به بعد ذلك تظهر في السجل أدناه مرفوضة. وهكذا تميّزون مفتاحًا ملغى من نقطة معطلة.",
  "sint.attemptsTitle": "تسجيلات لم تُطابَق، آخر سبعة أيام",
  "sint.attemptsBody": "كتب أحدهم رقمًا وظيفيًا لم يعرفه نظامكم. قليل منها أمر طبيعي. وكثير منها يعني عادة أن رمز الانضمام وصل إلى من لم يُقصد، وهذا شيء لا يستطيع التحقق منه سواكم.",
  "sint.logTitle": "ما أرسلناه إليكم",
  "sint.logBody": "كل مكالمة، وما ردّه طرفكم، والخطأ إن وُجد. تستطيعون تشخيص طرفكم دون أن تسألونا ماذا حدث.",
  "sint.logEmpty": "لا شيء بعد.",
  "sint.logWhen": "متى",
  "sint.logEvent": "الحدث",
  "sint.logStatus": "الحالة",
  "sint.logError": "الخطأ",
  "sint.logNoNames": "لا اسم ولا رقم وظيفي ولا معرّف يظهر في هذا السجل، أبدًا. سجل اتصال يدوّن عمّن كانت كل مكالمة يعيد بناء قائمة الموظفين التي لا نحتفظ بها، سطرًا سطرًا.",
