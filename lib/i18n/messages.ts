...
export const en = {
  ...
  */
  ...
  "pmsg.pay.rejected": "We could not match your transfer to our account. The reason: {reason}\n\nWe took nothing from you. Check the details and send the reference again from the same page.",
  ...
  "pmsg.support.body": "We have answered your message (reference {reference}). Open {link} and enter the code {code} to read the reply and any attachments. The code lasts seven days.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "pmsg.support.body": "رددنا على رسالتك (رقم المرجع {reference}). افتح {link} وأدخل الرمز {code} لقراءة الرد وأي مرفقات. الرمز صالح سبعة أيام.",
