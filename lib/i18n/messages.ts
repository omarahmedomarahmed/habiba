...
export const en = {
  ...
  */
  ...
  "prating.stillWriting": "{name} is still writing it. It arrives by email once approved.",
  ...
  "tnote.failedBody": "Little was captured. Check the transcript, then try again.",
  ...
  "tnote.maxSteps": "Four at most. Cut one to add another.",
  "tappr.title": "Before you close this session",
  "tappr.body": "Three things, one button. Nothing is published unless you tick it.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "tnote.failedBody": "لم يُلتقط إلا القليل. راجع التفريغ ثم أعد المحاولة.",
  ...
  "tnote.maxSteps": "أربع خطوات على الأكثر. احذف واحدة لتضيف أخرى.",
  "tappr.title": "قبل أن تُغلق هذه الجلسة",
  "tappr.body": "ثلاثة أمور وزرّ واحد. لا يُنشر شيء إلا إن أشّرت عليه.",
