...
export const ar: Record<MessageKey, string> = {
  ...
  "pmsg.homework.body": "ترك لك {name} شيئًا تجربه قبل جلستك القادمة. تجده في تطبيقك.",
  "pmsg.homework.link": "افتحه",
  "pmsg.assessment.subject": "بعض الأسئلة من معالجك",
  "pmsg.assessment.body": "أرسل لك {name} بعض الأسئلة لتجيب عنها في وقتك. تجدها في تطبيقك.",
