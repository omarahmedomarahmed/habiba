...
export const en = {
  ...
  */
  ...
  "devs.useCase1": "Employment verification",
  "devs.useCase1Body": "Your HR system answers one question about one person: is this identifier currently active. A boolean and a timestamp. We never read your directory, never sync it and never store a staff list, so there is no list endpoint to ask for. It answers only about somebody who has just given their own details inside an enrolment.",
  "devs.useCase2": "Clinician verification",
  "devs.useCase2Body": "Is this clinician verified with us, and by which body. A boolean and a source. Never a document, never a licence number.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "devs.useCase1": "التحقق من العمل",
  "devs.useCase1Body": "نظام الموارد البشرية عندك يجيب عن سؤال واحد عن شخص واحد: هل هذا المعرّف نشط الآن. قيمة صحيحة أو خاطئة ووقت. لا نقرأ دليلك أبدًا ولا نزامنه ولا نحفظ قائمة موظفين، فلا توجد نقطة تُعطي قائمة لتطلبها. ولا يجيب إلا عن شخص قدّم بياناته بنفسه للتو داخل عملية انضمام.",
  "devs.useCase2": "التحقق من المعالج",
  "devs.useCase2Body": "هل هذا المعالج موثّق معنا، ومن أي جهة. قيمة ومصدر. لا وثيقة أبدًا ولا رقم ترخيص.",
