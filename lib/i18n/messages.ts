...
export const en = {
  ...
  */
  ...
  "pay.stripeNote": "Stripe handles your card; we never see the number.",
  ...
  "dpo.joinedOf": "{joined} of {total} have joined",
  "dpo.joiningTells": "Joining tells us somebody is covered. It does not tell us, or you, whether they ever book anything.",
  "dpo.coveredPerYear": "Sessions covered per person, per year",
  "dpo.capPerSession": "Cap per session",
  ...
  "pnotice.accessGranted": "Somebody can now read your history. You can stop it any time.",
  "pnotice.historyAnswered": "Your old therapist answered your request. See your profile.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "pay.stripeNote": "سترايب تتولى بطاقتك، ولا نرى الرقم أبدًا.",
  ...
  "dpo.joinedOf": "انضمّ {joined} من {total}",
  "dpo.joiningTells": "الانضمام يخبرنا أن شخصًا مغطّى. ولا يخبرنا، ولا يخبرك، إن كان قد حجز شيئًا أصلًا.",
  "dpo.coveredPerYear": "عدد الجلسات المغطّاة للفرد في السنة",
  "dpo.capPerSession": "الحد الأقصى للجلسة",
  ...
  "pnotice.accessGranted": "صار بإمكان أحدهم قراءة تاريخك. يمكنك إيقاف ذلك متى شئت.",
  "pnotice.historyAnswered": "ردّ معالجك السابق على طلبك. راجع ملفك الشخصي.",
