...
export const en = {
  ...
  */
  ...
  "tnew.paygNotice": "On pay as you go: $1 per session, and $3 if the patient turns AI on, on your bill. A subscription covers both.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "tnew.paygNotice": "بنظام الدفع حسب الاستخدام: دولار واحد للجلسة، و٣ دولارات إذا فعّل المريض الذكاء الاصطناعي، على فاتورتك. الاشتراك يغطي الاثنين.",
