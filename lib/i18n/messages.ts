...
export const en = {
  ...
  */
  ...
  "records.bodyClinic": "Connect the practice's record system once, for every clinician here. Filing approved notes into it is not built yet; we will say here when it is.",
  "records.bodySolo": "Connect your record system. Filing approved notes back into it is not built yet; we will say here when it is.",
  ...
  "records.whatWeHold": "Your system is the record. Once filing is built we will file the approved note and read back one thing: the patient's name. Today we read nothing from it.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "records.bodyClinic": "اربط نظام سجلات العيادة مرة واحدة لكل المعالجين هنا. إيداع الملاحظات المعتمدة فيه لم يُبنَ بعد، وسنخبركم هنا حين يُبنى.",
  "records.bodySolo": "اربط نظام سجلاتك. إيداع الملاحظات المعتمدة فيه لم يُبنَ بعد، وسنخبرك هنا حين يُبنى.",
  ...
  "records.whatWeHold": "نظامك هو السجل. حين يُبنى الإيداع سنودع الملاحظة المعتمدة ونقرأ شيئًا واحدًا: اسم المريض. اليوم لا نقرأ منه شيئًا.",
