...
export const en = {
  ...
  */
  ...
  "apartner.billsBody": "Invoiced monthly, paid by bank transfer. Mark it paid when the money arrives.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "apartner.billsBody": "فاتورة شهرية تُدفع بتحويل بنكي. سجّلها مدفوعة حين يصل المبلغ.",
