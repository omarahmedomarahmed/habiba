...
export const en = {
  ...
  */
  ...
  "pracc.inviteBody": "A link you hand over in the room. They set a password and choose whether you keep access.",
  ...
  "portal.source.tokenBody": "A one-time credential for uploading this session's audio. It expires by itself, and you can revoke it.",
  ...
  "portal.new.recordBody": "Your patient is asked first, on their own screen. If they say no, the session runs the same without a transcript.",
  ...
  "portal.docs.journalsBlurb": "Written by them, between sessions. They gave you access to their history, which is what puts these here.",
  ...
  "portal.billing.noPayments": "Payments are not configured here, so nothing is charged. Sessions still record and notes are written.",
  ...
  "portal.codes.revoke": "Revoke a code when its poster goes out of date. Scanning a revoked one says so.",
  ...
  "portal.settings.whyHours": "The zone every time here is shown in, and the hour we will message your patients at.",
  ...
  "portal.copilot.credits": "Each completed session earns {count} copilot questions about that patient. They roll over for {months} months.",
  ...
  "tauth.checkInboxBody": "If an account exists for that address, a reset link is on its way. It works once, for an hour.",
  ...
  "trad.alertViewBody": "A single soft tone. You are now busy to everyone else, and they have sixty seconds.",
  ...
  "tcop.intro": "I have read every session in this chart and nothing outside it. Every answer shows which moment it came from.",
  ...
  "tplan.buyAheadBody": "The more you buy at once, the less each costs. You have a year to use them.",
  ...
  "tcon.gaveCodeBody": "Enter it and they are asked whether you may read their history. You see the answer on their record.",
  ...
  "tcon.askingBody": "They want what you hold added to the record they own. You need not agree, but say so: silence is worse than no.",
  ...
  "tra.beforeBody": "This history is for you. The system that read the session never saw it, so its finding is about today.",
  ...
  "troom.offRecordPatientWhy": "Audio stops now. What was captured stays: a note that rewrites itself is worse than one with a gap.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "pracc.inviteBody": "رابط تسلّمه في الغرفة. يضع كلمة مرور ويقرر إن كنت تحتفظ بالإذن.",
  ...
  "portal.source.tokenBody": "بيان اعتماد لمرة واحدة لرفع صوت هذه الجلسة. ينتهي وحده، ويمكنك إلغاؤه.",
  ...
  "portal.new.recordBody": "يُسأل مريضك أولًا على شاشته. وإن رفض تجري الجلسة كما هي بلا تفريغ.",
  ...
  "portal.docs.journalsBlurb": "كتبها هو بين الجلسات. ومنحك الإذن بتاريخه، وهذا ما وضعها هنا.",
  ...
  "portal.billing.noPayments": "الدفع غير مُعدّ هنا، فلا يُحصَّل شيء. وما زالت الجلسات تُسجَّل والملاحظات تُكتب.",
  ...
  "portal.codes.revoke": "ألغِ الرمز حين يقدم ملصقه. ومسح رمز ملغى يقول ذلك.",
  ...
  "portal.settings.whyHours": "التوقيت الذي تُعرض به كل الأوقات هنا، والساعة التي نراسل فيها مرضاك.",
  ...
  "portal.copilot.credits": "كل جلسة مكتملة تمنحك {count} سؤالًا للمساعد عن ذلك المريض. وتُرحَّل {months} شهرًا.",
  ...
  "tauth.checkInboxBody": "إن كان لذلك العنوان حساب، فرابط إعادة التعيين في طريقه. يعمل مرة واحدة لمدة ساعة.",
  ...
  "trad.alertViewBody": "نغمة واحدة خافتة. أنت الآن مشغول للجميع، ولديهم ستون ثانية.",
  ...
  "tcop.intro": "قرأت كل جلسة في هذا الملف ولا شيء خارجه. وكل إجابة تُظهر اللحظة التي جاءت منها.",
  ...
  "tplan.buyAheadBody": "كلما اشتريت أكثر دفعة واحدة قلّت تكلفة الواحدة. ولديك سنة لاستخدامها.",
  ...
  "tcon.gaveCodeBody": "أدخله فيُسأل إن كان يسمح لك بقراءة تاريخه. وترى الرد على سجله.",
  ...
  "tcon.askingBody": "يريد إضافة ما لديك إلى السجل الذي يملكه. لست ملزَمًا، لكن قل ذلك: الصمت أسوأ من لا.",
  "tcon.added": "أضفته",
  ...
  "tra.beforeBody": "هذا التاريخ لك أنت. لم يره النظام الذي قرأ الجلسة، فما وجده يخص اليوم.",
  ...
  "troom.offRecordPatientWhy": "يتوقف الصوت الآن. ويبقى ما سُجِّل: فالملاحظة التي تعيد كتابة نفسها أسوأ من واحدة بها فجوة.",
