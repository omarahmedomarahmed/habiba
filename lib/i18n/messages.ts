...
export const en = {
  ...
  */
  ...
  "pinv.phoneOnly": "WhatsApp is not connected yet: add an email, or pass the link on yourself.",
  ...
  "tcop.chip": "Session {when}, at {at}",
  "tcop.chipSession": "Session {when}",
  "tcop.chipAt": "At {at}",
...
export const ar: Record<MessageKey, string> = {
  ...
  "tcop.chip": "جلسة {when}، عند {at}",
  "tcop.chipSession": "جلسة {when}",
  "tcop.chipAt": "عند {at}",
