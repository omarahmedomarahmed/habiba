...
export const en = {
  ...
  */
  ...
  "pmsg.supportIn.subject": "We have your message, reference {reference}",
  "pmsg.supportIn.body": "We have your message (reference {reference}). A named person answers within {hours} hours. Open {link} and enter the code {code} to see where it stands. The code lasts seven days.",
  "pmsg.supportIn.link": "See where it stands",
...
export const ar: Record<MessageKey, string> = {
  ...
  "pmsg.supportIn.subject": "وصلتنا رسالتك، رقم المرجع {reference}",
  "pmsg.supportIn.body": "وصلتنا رسالتك (رقم المرجع {reference}). يرد عليك شخص باسمه خلال {hours} ساعة. افتح {link} وأدخل الرمز {code} لترى أين وصلت. الرمز صالح سبعة أيام.",
  "pmsg.supportIn.link": "اعرف أين وصلت",
