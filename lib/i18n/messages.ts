...
export const en = {
  ...
  */
  ...
  "access.explain.gated": "The copilot is waiting on two things for this person: a diagnosis, and a history you type or dictate. Add both and it opens on this record.",
  "access.explain.revoked": "This person has not granted you access to their profile. You can still see your own sessions, your own notes and your earlier copilot conversation, but not their live profile, their files, or their current diagnosis.",
  "access.explain.unclaimed": "This record is yours alone until the person it describes claims it. Add a diagnosis and a history to get the most out of the copilot.",
  "access.explain.noRelationship": "You have no record for this person, so the copilot only has this session's transcript.",
  "access.copilotRefused": "You cannot use the copilot for this patient.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "access.explain.gated": "ينتظر المساعد أمرين لهذا الشخص: تشخيصًا، وتاريخًا تكتبه أو تمليه. أضف الاثنين فيُفتح على هذا الملف.",
  "access.explain.revoked": "لم يمنحك هذا الشخص إذنًا بالاطلاع على ملفه. ما زال بإمكانك رؤية جلساتك وملاحظاتك ومحادثتك السابقة مع المساعد، لكن ليس ملفه الحي ولا ملفاته ولا تشخيصه الحالي.",
  "access.explain.unclaimed": "هذا الملف لك وحدك حتى يطالب به الشخص الذي يصفه. أضف تشخيصًا وتاريخًا لتستفيد من المساعد أكثر.",
  "access.explain.noRelationship": "ليس لديك ملف لهذا الشخص، لذلك لا يملك المساعد إلا نص هذه الجلسة.",
  "access.copilotRefused": "لا يمكنك استخدام المساعد لهذا المريض.",
