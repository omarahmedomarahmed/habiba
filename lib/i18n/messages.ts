...
export const en = {
  ...
  */
  ...
  "apartner.body": "Outside clinical tenancy, owning no organisation. Activating lets them hold a key.",
  ...
  "ateam.body": "Staff work the queues; managers also see their health. We email the link.",
  ...
  "acheckin.body": "A scheduled how-are-you message. Every number is yours; watch the mute rate.",
  ...
  "asupport.replyHint": "What was done. They read it on an authenticated page, never in email.",
