...
export const en = {
  ...
  */
  ...
  "sponsor.planBody": "At the last twelve weeks' rate, it lasts about {weeks} more weeks.",
  ...
  "topup.unavailable": "Top-ups are not set up yet. Talk to us to arrange it.",
  /*
...
export const ar: Record<MessageKey, string> = {
  ...
  "sponsor.planBody": "بمعدل الأسابيع الاثني عشر الماضية تكفي نحو {weeks} أسبوعًا أخرى.",
