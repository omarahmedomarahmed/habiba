...
export const en = {
  ...
  */
  ...
  "sponsor.apply.body": "Tell us who you are; we will call. Nothing is set up before we speak.",
  ...
  "sponsor.topUpBody": "The minimum is {min}. It pays for sessions here and cannot be taken out as cash.",
  ...
  "sponsor.coverageFrom": "Saved. It takes effect on {date}; anybody already booked keeps their percentage.",
  ...
  "ateam.body": "Staff work the queues; a manager also sees how they are doing. We email the link.",
  ...
  "sponsor.preferProof": "A domain email is proof: we send it a code. A staff number is only checked for shape.",
  ...
  "acheckin.noBodies": "No reply is shown here. A worrying one reaches their therapist by the crisis path.",
  ...
  "sponsor.apply.country": "Where you are",
  "sponsor.apply.egypt": "Egypt",
...
export const ar: Record<MessageKey, string> = {
  ...
  "sponsor.apply.country": "أين أنتم",
  "sponsor.apply.egypt": "مصر",
