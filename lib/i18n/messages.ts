...
export const en = {
  ...
  */
  ...
  "pclaim.err.handleTaken": "Your number or address is already on the record you claimed, so this one cannot be added to it. Ask the therapist who holds it to share it with you.",
  ...
  "pclose.goes": "This closes your sign-in. You are signed out on every device, your email is released so you can sign up again later, check-in messages stop, and every clinician you let read your history loses that access.",
  "pclose.stays": "What your clinicians already hold stays with them. Their notes, your sessions with them and the files they keep are part of their clinical record, and deleting your account does not erase them. Sessions you have booked are not cancelled; cancel them first if you want to.",
  "pclose.word": "DELETE",
  ...
  "apartner.billsBody": "Invoiced at month end and paid by bank transfer. Mark one paid when the money is in the account.",
  ...
  "apartner.errDocsApproved": "Approved on these documents. Withdraw the approval to change them.",
  ...
  "asponsor.ownerOnly": "Only an owner can change a sponsor. Open one for its pot, returns and transfers.",
  ...
  "admin.invited": "Invited. They get an email with a link to set their password.",
  ...
  "ateam.ownerBody": "An owner reaches everything, money included, through the same second step. Ledger adjustments need two owners; once there are two, another needs one of them.",
  ...
  "acontent.badLogo": "Not saved: logo \"{value}\" must be a path on this site, like /logos/name.svg. Another host would learn who read the page.",
  /* 🔴 AE10: a cart waiting on a second person's credit is theirs to complete or decline. */
  "atransfer.discardAsked": "You asked a second person to credit this, so they complete or decline it.",
  ...
  "pmsg.walletCredited.body": "The booking was cancelled, so the {amount} you sent is in your wallet for your next session. If you would rather have it back, ask us and we will refund it.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "pclaim.err.handleTaken": "رقمك أو عنوانك مسجل بالفعل على السجل الذي استلمته، فلا يمكن إضافة هذا السجل إليه. اطلب من المعالج الذي يحتفظ به أن يشاركه معك.",
  ...
  "pclose.goes": "هذا يغلق دخولك. ستُسجَّل خارجًا من كل الأجهزة، ويُحرَّر بريدك الإلكتروني لتتمكن من التسجيل لاحقًا، وتتوقف رسائل السؤال عن حالك، ويفقد كل معالج سمحت له بقراءة تاريخك هذا الإذن.",
  "pclose.stays": "ما لدى معالجيك يبقى معهم. ملاحظاتهم وجلساتك معهم والملفات التي يحتفظون بها جزء من سجلهم السريري، وحذف حسابك لا يمحوها. الجلسات التي حجزتها لا تُلغى؛ ألغها أولًا إن أردت.",
  "pclose.word": "حذف",
  ...
  "apartner.billsBody": "تصدر الفاتورة في نهاية الشهر وتُدفع بتحويل بنكي. سجّلها مدفوعة حين يصل المبلغ إلى الحساب.",
  ...
  "asponsor.ownerOnly": "تغيير جهة راعية من صلاحية المالك وحده. افتح أيًّا منها لترى محفظتها ومرتجعاتها وتحويلاتها.",
  ...
  "admin.invited": "تمت الدعوة. يصلهم بريد فيه رابط لتعيين كلمة المرور.",
  ...
  "ateam.ownerBody": "يصل المالك إلى كل شيء، بما فيه المال، بالخطوة الثانية نفسها. تعديلات الدفاتر تحتاج إلى مالكَين؛ وبعد وجودهما يحتاج أي مالك آخر إلى أحدهما.",
  ...
  "acontent.badLogo": "لم يُحفظ: الشعار \"{value}\" يجب أن يكون مسارًا على هذا الموقع، مثل /logos/name.svg. أي موقع آخر سيعرف من قرأ الصفحة.",
  "atransfer.discardAsked": "طلبت من شخص ثانٍ أن يقيّد هذا، فهو من يكمله أو يرفضه.",
  ...
  "pmsg.walletCredited.body": "أُلغي الحجز، لذا فإن {amount} التي أرسلتها موجودة في محفظتك لجلستك القادمة. إن أردت استردادها، اطلب منا وسنعيدها إليك.",
  ...
  "pmsg.booked.body": "لديك موعد مع {therapist} في {when}.\n\nإن لم يناسبك، أخبر معالجك في أقرب وقت لتعود الساعة إلى الجدول ويستفيد منها غيرك.",
  ...
  "pmsg.reminder.body": "تذكير بأن جلستك مع {therapist} في {when}.\n\nإن لم تستطع الحضور، أخبر معالجك في أقرب وقت لتعود الساعة إلى الجدول ويستفيد منها غيرك.",
  ...
  "pmsg.rating.body": "ملخّص جلستك بتاريخ {date} جاهز من {therapist}. ملخّص قصير كُتب لك: ما تحدثتما عنه وما اتفقتما على تجربته، وهو بانتظارك على الرابط نفسه الذي انضممت منه.",
  "pmsg.rating.button": "افتح ملخّصي",
  "pmsg.rating.ask": "سنطلب منك تقييم الجلسة أولًا. يستغرق ذلك دقيقة تقريبًا، ولن يصل إلى {therapist} اسم من قيّم الجلسة، وهو الشيء الوحيد الذي نطلبه منك.",
