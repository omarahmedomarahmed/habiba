...
export const en = {
  ...
  */
  ...
  "sponsor.preferProof": "An email on your domain is proof: we send it a code. A staff number is only checked for shape.",
  ...
  "portal.codes.blurb": "For the wall, or the end of a session. Somebody scans it and claims their notes.",
