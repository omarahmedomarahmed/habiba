...
export const en = {
  ...
  */
  ...
  "pclaim.err.inviteMismatch": "This link is for a different phone number. Sign up with the number your therapist has for you, or ask them for a new link.",
  ...
  "pmsg.reminder.body": "A reminder that your session with {therapist} is {when}.\n\nIf you cannot make it, tell them early so the hour can go to somebody else.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "join.privateNoteTransfer": "هتدفع بتحويل بنكي في الصفحة الجاية. الجلسة بتتفتح أول ما نأكد التحويل.",
  ...
  "pclaim.allYoursBody": "مربوطة بحسابك. مفيش حاجة تانية مستنية.",
  ...
  "pclaim.err.inviteMismatch": "هذا الرابط لرقم هاتف مختلف. سجّل بالرقم الذي لدى معالجك، أو اطلب منه رابطًا جديدًا.",
  ...
  "w1a.walletCreditBody": "المبلغ اللي دفعته في محفظتك لجلستك الجاية. اطلب منّا نبعته لحسابك في البنك بدل كده.",
  ...
  "pchange.refundWallet": "في محفظتك لجلستك الجاية. اطلب منّا نبعته لحسابك في البنك بدل كده.",
  "pchange.transferWaiting": "تحويلك لسه بيتراجع. لو ألغيت، هيدخل محفظتك.",
  "pchange.transferWaitingDone": "تحويلك لسه بيتراجع. أول ما يوصل هيدخل محفظتك.",
  "pchange.covered": "ميزتك دفعت تمنها، فالإلغاء مش هيكلفك حاجة.",
  "pchange.coveredDone": "ميزتك دفعت تمنها، فماتخصمش منك حاجة.",
  ...
  "pmsg.rating.ask": "سنطلب منك تقييم الجلسة أولًا. يستغرق دقيقة، ولن يعرف {therapist} من قيّمها.",
