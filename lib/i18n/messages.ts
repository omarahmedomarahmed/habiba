...
export const en = {
  ...
  */
  ...
  "apartner.documentsHint": "An https link to the folder you read them in. Approval needs it.",
  ...
  "apartner.errDocsApproved": "They are approved on the documents already recorded. Withdraw the approval to change them.",
  ...
  "ateam.ownerBody": "An owner reaches everything, settings and money included, and signs in with the same second step as the team. A ledger adjustment needs two owners, so with one it cannot be posted. Once there are two, a further owner is completed by one of the others.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "apartner.documentsHint": "رابط https للمجلد الذي قرأتها فيه. الموافقة تحتاج إليه.",
  ...
  "apartner.errDocsApproved": "وُوفق عليهم بناءً على الوثائق المسجلة. اسحب الموافقة لتغييرها.",
  ...
  "ateam.ownerBody": "يصل المالك إلى كل شيء، بما في ذلك الإعدادات والمال، ويدخل بالخطوة الثانية نفسها التي يستخدمها الفريق. تعديل الدفاتر يحتاج إلى مالكَين، فلا يمكن ترحيله بمالك واحد. وبعد وجود مالكَين، يُكمل دعوة أي مالك إضافي أحدُ الآخرين.",
