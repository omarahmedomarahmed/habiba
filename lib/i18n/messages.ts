...
export const en = {
  ...
  */
  ...
  "tnote.signedNote": "Signed. It stays in the chart, never sent to a patient.",
  ...
  "tnote.nothingSent": "Nothing sent yet. Approving releases it, never the clinical note.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "tnote.nothingSent": "لم يُرسل شيء بعد. الاعتماد يطلقه، والملاحظة السريرية لا تُرسل أبدًا.",
