...
export const en = {
  ...
  */
  ...
  "portal.new.consentWhoInPerson": "Your patient, on your screen, before you start",
  ...
  "tnote.notRecordedBody": "{name} did not agree to recording, so nothing was captured and there is nothing to write a note from. Write your own account of the session.",
  "tnote.writeOwn": "Write the note yourself",
  ...
  "tattr.oneMic": "One microphone heard both of you, and the cut falls on a clock rather than at the turns. Where a line holds two people we leave it open rather than guess: a wrong name in a record is worse than none. You were there, so you can say.",
  ...
  "troom.detect": "Detect",
  "troom.resume": "Resume",
  "troom.consentAsk": "Nothing is recorded until {name} says yes.",
  "troom.consentHand": "Turn the screen towards them and let them choose. You can run the session either way.",
  "troom.consentYes": "Yes, you may record",
  "troom.consentNo": "No, do not record",
  "troom.consentWaiting": "Nothing is recorded until {name} says yes on their screen.",
  "troom.resumeNeedsYes": "Needs their yes",
  "troom.pressStartNoRecord": "Press Start session to begin. Nothing will be recorded.",
  "troom.noteOwnOnEnd": "Nothing is recorded, so you write the note yourself after the session.",
  "troom.nothingKept": "Nothing said now is recorded or kept.",
  "troom.ending": "Ending…",
...
export const ar: Record<MessageKey, string> = {
  ...
  "portal.new.consentWhoInPerson": "مريضك، على شاشتك، قبل أن تبدأ",
  ...
  "tnote.notRecordedBody": "لم يوافق {name} على التسجيل، لذلك لم يُلتقط شيء ولا يوجد ما تُكتب منه ملاحظة. اكتب روايتك أنت للجلسة.",
  "tnote.writeOwn": "اكتب الملاحظة بنفسك",
  ...
  "tattr.oneMic": "ميكروفون واحد سمعكم الاتنين، والتسجيل بيتقطّع بالوقت مش عند تبديل الكلام. لما السطر يبقى فيه آخر دور وأول اللي بعده، بنسيبه مفتوح بدل ما نخمّن، لأن اسم غلط في السجل أسوأ من مفيش اسم. إنت كنت موجود، فتقدر تقول.",
  "tcon.theirCode": "رمزه",
  ...
  "troom.consentAsk": "لا يُسجَّل شيء حتى يوافق {name}.",
  "troom.consentHand": "أدِر الشاشة نحوه ودعه يختار. يمكنك إجراء الجلسة في الحالتين.",
  "troom.consentYes": "نعم، يمكنك التسجيل",
  "troom.consentNo": "لا، لا تسجّل",
  "troom.consentWaiting": "لا يُسجَّل شيء حتى يوافق {name} على شاشته.",
  "troom.resumeNeedsYes": "يحتاج إلى موافقته",
  "troom.pressStartNoRecord": "اضغط ابدأ الجلسة للبدء. لن يُسجَّل شيء.",
  "troom.noteOwnOnEnd": "لا يُسجَّل شيء، لذلك تكتب الملاحظة بنفسك بعد الجلسة.",
  "troom.nothingKept": "لا يُسجَّل ولا يُحفظ شيء مما يُقال الآن.",
