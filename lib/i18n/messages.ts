...
export const en = {
  ...
  */
  ...
  "sponsor.ledgerWeekly": "Published weekly, the Monday after.",
  "sponsor.ledgerLive": "Published as each is paid.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "sponsor.ledgerWeekly": "تُنشر أسبوعيًا، يوم الاثنين التالي.",
  "sponsor.ledgerLive": "تُنشر عند دفع كل منها.",
