...
export const en = {
  ...
  */
  ...
  "cassess.timingsBody": "A long pause on one item is information a transcript does not carry. A blank means the client reported something implausible and it was not recorded.",
  ...
  "portal.source.tokenOnce": "Copy this now. It is shown once and stored only as a hash, so nobody here can read it back to you.",
  ...
  "sponsor.rosterBody": "Everybody who has activated the benefit. You can remove somebody, which ends the funding and nothing else.",
  ...
  "sponsor.whyWeekly": "Weekly is the finest we will ever show, for any client, at any size. A single day's spend, set beside something you already know about, can identify a person. A week cannot.",
  "sponsor.suppressed": "Not enough activity to report yet",
  "sponsor.suppressedBody": "We do not publish a figure for a period with very little activity, because a small number can identify somebody. It rolls into the next one.",
  /* 🔴 C240 — on their own screen, so nobody buys this expecting otherwise. */
  "sponsor.noAttendance": "We never confirm to you whether any individual attended, so attendance cannot be required through us. That is deliberate.",
  "sponsor.code": "Your joining code",
  "sponsor.codeBody": "Circulate this internally and print it. It names your organisation and nothing else, so it is safe on a wall.",
  ...
  "sponsor.apply.sentBody": "Your account is open but nothing is active yet. We agree the terms with you on the call, before any money changes hands.",
  ...
  "sponsor.inv.spendableOnly": "This amount is held as a balance spendable on therapy sessions on this platform. It cannot be withdrawn as cash or transferred, and the refund and expiry terms agreed with your account apply.",
  ...
  "sponsor.preferProof": "An email address on your domain is the one we recommend: we send a code to it, so it is proof rather than a guess. A staff number is only checked against its shape, which means somebody outside your organisation can guess one, and that risk is yours.",
  ...
  "sponsor.listedBody": "Off by default. Turning it on puts your name in a list people can search, which tells anybody looking that you cover therapy for your staff.",
  "sponsor.listedOn": "Listed",
  "sponsor.listedOff": "Reachable only with your code",
  "sponsor.verifyCycle": "We re-check each person's details every {months} months. Nobody answering pauses their funding and nothing else, and we can undo it in one step.",
  /* ------------------------------------------------------------- the clinic */
  /*
  ...
  "clinic.scheduleBody": "Your clinicians' appointments. A name and a time, because you are paying for the hour. Nothing else about anybody, in any form.",
  ...
  "clinic.neverSees": "You will never see a note, a transcript, a journal, a summary, a risk flag or a diagnosis here. Not hidden behind a setting: it is not built. What happens in a session belongs to the patient and their clinician.",
  ...
  "clinic.suppressedBody": "We do not publish a figure for a period with very little activity, because a small number can identify somebody. It rolls into the next one.",
  ...
  "clinic.cannotVerify": "Only the clinician can complete their own verification, and only with us. You can see where it has got to and chase them. We will not take your word for a licence, and that is what makes the badge on their profile worth anything.",
  ...
  "clinic.removeConfirm": "They move to a practice of their own straight away and any meeting account they connected here is disconnected, because it was yours. The records of the sessions they ran here stay with this practice, unchanged.",
  "clinic.billsTitle": "Your bills",
  /* 🔴 C263 — why there is no itemised breakdown, said where it is missing. */
  "clinic.billsBody": "A total for the period, never a line per session. Your clinicians are billed the platform fee on every session and the AI fee on the ones where the patient turned recording on, and itemising that would tell you which patients did. The per-session detail is with the clinician whose patients they are.",
  ...
  "clinic.join.body": "Set a password and you are in. You verify your own licence with us afterwards, exactly as anybody who signed up alone does.",
  "clinic.join.noPrivate": "Every session on this account belongs to {name}. They pay the platform fee and the AI fee, and they see each patient's name and appointment time because they are paying for the hour. They never see a note, a transcript or anything else about a session.",
  "clinic.join.keepSolo": "If you also want private patients of your own, keep a separate account for them with a different email address. That is the honest way to hold both and it costs you nothing.",
  ...
  "records.whatWeHold": "Once connected, your system is the record. We file the approved note into it and we read one thing back: the patient's name, so a schedule row and a consent prompt are not blank. We do not read or keep a date of birth, a record number, an address, a payer, a problem list, a medication or an allergy, and there is nowhere in our database to put one.",
  "records.whatWeKeep": "What we keep is what we made: the session, the transcript we recorded under the patient's consent, the note and who approved it. That stays with us on our own schedule rather than yours, because the person it answers to is the patient, and they can take it and leave, including leaving you.",
  "records.severOnDisconnect": "If you disconnect, we stop being able to resolve your patient identifiers the same moment. The clinical record we made stays, held for the patient, with no link back to your chart.",
  "records.notConfigured": "This deployment cannot hold a record-system connection yet. It needs a client registration and a token sealing key, and it has {missing}.",
...
export const ar: Record<MessageKey, string> = {
  ...
  "cassess.timingsBody": "التوقف الطويل عند بند واحد معلومة لا يحملها النص المكتوب. الفراغ يعني أن التطبيق أرسل رقمًا غير معقول فلم يُسجَّل.",
  ...
  "portal.source.tokenOnce": "انسخها الآن. تُعرض مرة واحدة وتُخزَّن كبصمة فقط، فلا أحد هنا يستطيع قراءتها لك مرة أخرى.",
  ...
  "sponsor.rosterBody": "كل من فعّل الميزة. يمكنك إزالة شخص، وهذا ينهي التمويل ولا شيء غيره.",
  ...
  "sponsor.suppressedBody": "لا ننشر رقمًا لفترة نشاطها ضعيف جدًا، لأن الرقم الصغير قد يحدد شخصًا. ويُضاف إلى الفترة التالية.",
  "sponsor.noAttendance": "لا نؤكد لك أبدًا حضور أي فرد، فلا يمكن فرض الحضور من خلالنا. وهذا مقصود.",
  "sponsor.code": "رمز الانضمام الخاص بك",
  "sponsor.codeBody": "وزّعه داخليًا واطبعه. يحمل اسم جهتك ولا شيء غيره، فهو آمن على الحائط.",
  ...
  "sponsor.apply.sentBody": "حسابكم مفتوح ولا شيء مفعّل بعد. نتفق على الشروط معكم في الاتصال، قبل أي مبلغ.",
  ...
  "sponsor.inv.spendableOnly": "هذا المبلغ محفوظ كرصيد يُنفق على جلسات العلاج النفسي في هذه المنصة فقط. لا يمكن سحبه نقدًا ولا تحويله، وتنطبق شروط الاسترداد وانتهاء الصلاحية المتفق عليها مع حسابك.",
  ...
  "sponsor.preferProof": "البريد على نطاقكم هو ما نوصي به: نرسل رمزًا إليه، فهو إثبات وليس تخمينًا. أما الرقم الوظيفي فلا نتحقق منه إلا من شكله، أي أن شخصًا من خارج جهتكم قد يخمّنه، وهذه المسؤولية عليكم.",
  ...
  "sponsor.listedBody": "مغلق افتراضيًا. تشغيله يضع اسمكم في قائمة يبحث فيها الناس، وهذا يخبر كل من ينظر أنكم تغطون العلاج النفسي لفريقكم.",
  "sponsor.listedOn": "مدرج",
  "sponsor.listedOff": "يُوصل إليكم بالرمز فقط",
  "sponsor.verifyCycle": "نعيد التحقق من بيانات كل شخص كل {months} أشهر. من لا يجيب يتوقف تمويله ولا شيء غيره، ونستطيع التراجع عن ذلك بخطوة واحدة.",
  /* --------------------------------------------------------------- العيادة */
  ...
  "clinic.scheduleBody": "مواعيد معالجيكم. اسم ووقت، لأنكم تدفعون مقابل الساعة. ولا شيء آخر عن أي شخص، بأي صورة.",
  "clinic.scheduleEmpty": "لا مواعيد هذا الأسبوع.",
  "clinic.prevWeek": "أسبوع سابق",
  "clinic.nextWeek": "أسبوع تالٍ",
  "clinic.week": "أسبوع {date}",
  "clinic.neverSees": "لن تروا هنا أبدًا ملاحظة ولا نصًا ولا مفكرة ولا ملخصًا ولا إشارة خطر ولا تشخيصًا. وليس مخفيًا خلف إعداد: هو غير مبني. ما يحدث في الجلسة ملك المريض ومعالجه.",
  "clinic.usageTitle": "الجلسات والإنفاق، أسبوعًا بأسبوع",
  "clinic.suppressed": "النشاط لا يكفي للتقرير بعد",
  "clinic.suppressedBody": "لا ننشر رقمًا لفترة نشاطها ضعيف جدًا، لأن الرقم الصغير قد يحدد شخصًا. ويُضاف إلى الفترة التالية.",
  ...
  "clinic.cannotVerify": "المعالج وحده يُكمل توثيقه، ومعنا فقط. تستطيعون رؤية ما وصل إليه ومتابعته. ولن نأخذ بكلمتكم عن ترخيص، وهذا ما يجعل الشارة على ملفه ذات قيمة.",
  "clinic.invitePending": "مدعو، ولم يقبل بعد",
  "clinic.revoke": "ألغِ الدعوة",
  "clinic.remove": "أزِله من العيادة",
  "clinic.removeConfirm": "ينتقل إلى عيادة خاصة به فورًا، ويُفصل أي حساب اجتماعات ربطه هنا لأنه كان حسابكم. وسجلات الجلسات التي أجراها هنا تبقى مع هذه العيادة كما هي.",
  "clinic.billsTitle": "فواتيرك",
  "clinic.billsBody": "إجمالي للفترة، لا سطر لكل جلسة. يُحاسب معالجوكم على رسم المنصة في كل جلسة، وعلى رسم الذكاء الاصطناعي في الجلسات التي فعّل فيها المريض التسجيل، وتفصيل ذلك يخبركم من فعّله. التفصيل لكل جلسة عند المعالج الذي هم مرضاه.",
  ...
  "clinic.join.body": "ضع كلمة مرور وتكون بالداخل. توثّق ترخيصك معنا بعد ذلك، تمامًا كمن سجّل بنفسه.",
  "clinic.join.noPrivate": "كل جلسة على هذا الحساب تعود إلى {name}. هم يدفعون رسم المنصة ورسم الذكاء الاصطناعي، ويرون اسم كل مريض ووقت موعده لأنهم يدفعون مقابل الساعة. ولا يرون أبدًا ملاحظة ولا نصًا ولا أي شيء آخر عن الجلسة.",
  "clinic.join.keepSolo": "إن أردت مرضى خاصين بك أيضًا، احتفظ بحساب منفصل لهم ببريد مختلف. هذه هي الطريقة الصريحة للجمع بينهما ولا تكلفك شيئًا.",
  ...
  "records.whatWeHold": "بعد الربط يصبح نظامكم هو السجل. نودع فيه الملاحظة المعتمدة ونقرأ منه شيئًا واحدًا: اسم المريض، حتى لا يكون صف الجدول ونافذة الموافقة فارغين. لا نقرأ ولا نحفظ تاريخ ميلاد ولا رقم سجل ولا عنوانًا ولا جهة تأمين ولا قائمة تشخيصات ولا دواءً ولا حساسية، ولا يوجد في قاعدة بياناتنا مكان لأي منها.",
  "records.whatWeKeep": "ما نحفظه هو ما صنعناه: الجلسة، ونص الجلسة الذي سجلناه بموافقة المريض، والملاحظة ومن اعتمدها. يبقى ذلك عندنا وفق جدولنا لا جدولكم، لأن من يخصه هو المريض، وله أن يأخذه ويرحل، بما في ذلك الرحيل عنكم.",
  "records.severOnDisconnect": "إن قطعت الاتصال فسنفقد القدرة على تحليل معرّفات مرضاكم في اللحظة نفسها. والسجل السريري الذي صنعناه يبقى محفوظًا للمريض، بلا رابط إلى سجلكم.",
  "records.notConfigured": "هذا النشر لا يستطيع بعد حمل اتصال بنظام سجلات. يحتاج تسجيل عميل ومفتاح تشفير للرموز، والناقص هو {missing}.",
