...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: t("meta.whatHasHappened"), robots: { index: false } };
}
...
export default async function NoticesPage() {
  ...
  return (
    <main className="mx-auto flex flex-col min-h-dvh w-full max-w-lg gap-4 px-5 pt-16 pb-10">
      ...
      <h1 className="text-[26px] leading-tight font-bold tracking-tight text-balance text-navy-700">{t("pnotice.title")}</h1>
